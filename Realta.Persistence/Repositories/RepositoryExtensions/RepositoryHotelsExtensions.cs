...
namespace Realta.Persistence.Repositories.RepositoriesExtensions
{
    public static class RepositoryHotelsExtensions
    {
        ...
        public static IQueryable<Hotels> Sort(this IQueryable<Hotels> hotel, string orderByQueryString)
        {
            if (string.IsNullOrWhiteSpace(orderByQueryString))
                return hotel.OrderBy(e => e.HotelName);
            ...
            return hotel.OrderBy(orderQuery);
        }
    }
}
